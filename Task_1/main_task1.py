...
if shooting_ref:
    ...
    print(f'      Computing time: {time.time() - t_init} s')
...
if shooting_convergence:
    ...
    for nn in n_list:
        ...
        if nn < N_ref_sh:
            ...
            plt.grid(which='both')
            plt.legend()
            plt.savefig(f'./Figures/shooting_N_{nn}_y.png')
        ...
        if nn < N_ref_sh:
            ...
            plt.grid(which='both')
            plt.legend()
            plt.savefig(f'./Figures/shooting_N_{nn}_err.png')
    ...
    plt.grid(which='both')
    plt.legend()
    plt.savefig(f'./Figures/shooting_all_y.png')
    ...
    plt.grid(which='both')
    plt.legend()
    plt.savefig(f'./Figures/shooting_all_err.png')
    ...
    plt.grid(which='both')
    plt.savefig(f'./Figures/shooting_t_exe.png')
    ...
    plt.grid(which='both')
    plt.savefig(f'./Figures/shooting_max_err.png')
    ...
    plt.ylim(min(max_eps)*0.1, max(max_eps)*10)
    plt.grid(which='both')
    plt.savefig(f'./Figures/shooting_max_err_vs_t_exe.png')
...
if finite_diff_convergence:
    ...
    for nn in n_list:
        ...
        if nn < N_ref_fd:
            ...
            plt.grid(which='both')
            plt.legend()
            plt.savefig(f'./Figures/finite_diff_N_{nn}_y.png')
        ...
        if nn < N_ref_fd:
            ...
            plt.grid(which='both')
            plt.legend()
            plt.savefig(f'./Figures/finite_diff_N_{nn}_err.png')
    ...
    plt.grid(which='both')
    plt.legend()
    plt.savefig(f'./Figures/finite_diff_all_y.png')
    ...
    plt.grid(which='both')
    plt.legend()
    plt.savefig(f'./Figures/finite_diff_all_err.png')
    ...
    plt.ylim(min(t_exe_list)*0.1, max(t_exe_list)*10)
    plt.grid(which='both')
    plt.savefig(f'./Figures/finite_diff_t_exe.png')
    ...
    plt.ylim(min(max_eps)*0.1, max(max_eps)*10)
    plt.grid(which='both')
    plt.savefig(f'./Figures/finite_diff_max_err.png')
    ...
    plt.ylim(min(max_eps)*0.1, max(max_eps)*10)
    plt.grid(which='both')
    plt.savefig(f'./Figures/finite_diff_max_err_vs_t_exe.png')
...
if shooting_deform:
    ...
    for lf in factor_list:
        ...
        plt.ylim(min(y_plot)*1.1 - 0.1, max(y_plot)*1.1 + 0.1)
        plt.grid(which='both')
        plt.savefig(f'./Figures/test_shooting_lf_{params["load_factor"]}_N_{N}_momentum.png')
        ...
        plt.ylim(min(y_plot)*1.1 - 0.1, max(y_plot)*1.1 + 0.1)
        plt.grid(which='both')
        plt.savefig(f'./Figures/test_shooting_lf_{params["load_factor"]}_N_{N}_deformation.png')
